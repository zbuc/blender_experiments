...
def test_frustum_case():
    ...
    print(f"  Frustum: r_bottom={sf.radius_bottom}, r_top={sf.radius_top}, h={sf.height}")
...
def test_gradient_computation():
    ...
    assert np.all(np.isfinite(grads['orientation'])), "Orientation gradients should be finite"
    assert np.isfinite(grads['radius_bottom']), "Radius_bottom gradient should be finite"
